  ...
  const totalCartItems = cartCtx.items.reduce((totalNumberOfItems, item) => {
    ...
    <header className='flex items-center justify-between px-10 py-12'>
       <div className='flex items-center gap-4'>
        ...
        <button onClick={props.openCart} className='p-2 m-2 mr-20 text-black bg-red-500 border-black rounded-2xl text-8 md:mr-2 hover:bg-red-800'>Cart ({totalCartItems})</button>
    </header>
